...
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point(shape=1)
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point(shape=1)
...
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point(shape=1) + geom_smooth()
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point(shape=1) + geom_smooth()
